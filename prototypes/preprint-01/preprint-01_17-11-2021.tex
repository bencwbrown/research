...
\begin{document}
	...
	\begin{proof}
		...
		which implies
		\begin{align*}
		\langle y,\, \pi_{\ast}(e_{i}) \rangle &= \langle u_{i}, \, y \rangle \geq \lambda_{i}, \text{ for all } i \not\in A, \\
		\text{and } \quad  \langle y,\, \pi_{\ast}(e_{i}) \rangle &= \langle u_{i}, \, y \rangle \leq \lambda_{i}, \text{ for all } i \in A.
		\end{align*}
