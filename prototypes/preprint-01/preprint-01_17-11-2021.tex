...
\begin{document}
	...
	\begin{proof}
		...
		\[
			\langle e_{i}, \, \pi^{\ast}(y) \rangle \geq \lambda_{i}, \text{ for all } i \not\in A; \quad \text{ and } \quad  \langle e_{i}, \, \pi^{\ast}(y) \rangle \leq \lambda_{i}, \text{ for all } i \in A
		\]
		implies
		\[
		\langle \pi_{\ast}(e_{i}), \, y \rangle = \langle u_{i}, \, y \rangle \geq \lambda_{i}, \text{ for all } i \not\in A; \quad \text{ and } \quad  \langle \pi_{\ast}(e_{i}), \, \pi^{\ast}(y) \rangle = \langle u_{i}, \, \pi^{\ast}(y) \rangle \leq \lambda_{i}, \text{ for all } i \in A
		\]
	\end{proof}
