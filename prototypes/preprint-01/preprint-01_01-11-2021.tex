...
\begin{document}
	...
	Suppose for now that $K$ is connected, then Both of these have a residual $T^{d}$-action which is effective, and also Hamiltonian in the case of $X$, hyper-Hamiltonian in the case of $M$. 
