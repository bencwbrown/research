...
\begin{document}
	...
	\]
	is called a \emph{hypertoric variety}. Both of these have a residual $T^{d}$-action which is effective, and also Hamiltonian in the case of $X$, hyper-Hamiltonian in the case of $M$. When $K$ is not connected, 
