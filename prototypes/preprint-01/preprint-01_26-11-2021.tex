...
\begin{document}
    ...
    In the case when $X$ is compact, the image of $X$ under the moment map $\mubar$ is a convex polytope $\Delta$ in $(\mu^{d})^{\ast}$, by the Atiyah, Guillemin-Sternberg convexity theorem.
