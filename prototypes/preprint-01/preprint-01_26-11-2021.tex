   ...
   \end{equation}
    ...
    \begin{defn}
        ...
        \begin{enumerate}
            ...
            \item \textbf{rational}, if the edges meeting at the vertex $v$ are of the form, $v + ta_{i}$, with $t \geq 0$ and $a_{i} in \ZZ^{d}$. So the edges to the vertex $v$ emanate out in a direction given by the integral vectors, $a_{i}$;
        \end{enumerate}        
    \end{defn}
