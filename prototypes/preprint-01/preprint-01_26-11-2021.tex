...
\begin{document}
    ...
    In the case when $X$ is compact, the image of $X$ under the moment map $\mubar$ is a convex polytope $\Delta$ in $(\mft^{d})^{\ast}$, by the Atiyah, Guillemin-Sternberg convexity theorem (\cite{Ati82, GS82}). In this picture, the vectors $u_{i}$ appear as the inwards-pointing normal vectors to the half-spaces delimiting this polytope
