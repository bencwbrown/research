...
\begin{document}
   ...
   \end{equation}
    ...
    where each $u_{i} \in \RR^{n}$ in the inwards-pointing normal to the $i$-th ($d-1$)-dimensional face (a facet) of $\Delta$, and the $\lambda_{i}$ determine their position in $\RR^{d}$.
