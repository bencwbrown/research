...
\begin{document}
   ...
   \subsection{Below - Old Content} 
	...
	Let $(M, \w)$ be a compact symplectic manifold, and assume that the class of the symplectic form is integral, \ie $[\w] \in H^{2}(M; \ZZ)$. This condition implies existence of a Hermitian line bundle $\mcL \ra M$, whose $1$\textsuperscript{st} Chern class is $c_{1}(\mcL) = [\w]$ \cite{Duistermaat2011}.
