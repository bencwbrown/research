...
\begin{document}
   ...
   \subsection{Below - Old Content} 
    ...
    \[
    \begin{tikzcd}[ampersand replacement=\&]
        0 \ar[r] \& \mcC^{\infty}(\wedge^{0,0} \otimes \mcL) \ar[r, "\dbar_{\mcL}"] \& \mcC^{\infty}(\wedge^{0,1} \otimes \mcL) \ar[r, "\dbar_{\mcL}"] \& \ldots \ar[r, "\dbar_{\mcL}"] \& \mcC^{\infty}(\wedge^{0,2n} \otimes \mcL) \ar[r] \& 0.
    \end{tikzcd}
    \]
    ...
    \]
    Letting $\dbar_{\mcL}^{\ast}$ be the adjoint operator of $\dbar_{\mcL}$, defined with respect to the Hermitian inner-product, 
