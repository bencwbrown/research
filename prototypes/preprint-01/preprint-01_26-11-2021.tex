...
\begin{document}
    ...
    The subtorus $K$ acts on $\CC^{n}$ via the inclusion homomorphism $\imath$ into $T^{n}$, hence preserves its flat K\"ahler structure and form (\ref{eqn:flat-kahler-form})
