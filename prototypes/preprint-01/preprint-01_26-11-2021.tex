...
\begin{document}
   ...
   \end{equation}
    ...
    \begin{theorem}\label{thm:delzant-classification}
        Let $(X, \w, \mubar, T^{d})$ be a symplectic toric manifold with moment map $\mubar : X \ra (\mft^{d})^{\ast}$ for an effective Hamiltonian action of the torus $T^{d}$ on $X$, such that $\dim_{\CC} = d$. 
    \end{theorem}
