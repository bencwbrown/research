...
\begin{document}
   ...
   \subsection{Below - Old Content} 
    ...
    \[
    \begin{tikzcd}[ampersand replacement=\&]
        0 \ar[r] \& \mcC^{\infty}(\wedge^{0,0} \otimes \mcL) \ar[r, "\dbar_{\mcL}"] \& \mcC^{\infty}(\wedge^{0,1} \otimes \mcL) \ar[r, "\dbar_{\mcL}"] \& \ldots \ar[r, "\dbar"] \& \mcC^{\infty}(\wedge^{0,2n} \otimes \mcL) \ar[r, "\dbar"] \& 0.
    \end{tikzcd}
    \]
