...
\begin{document}
	...
	There is a residual Hamiltonian $S^{1}$-action for each hypertoric manifold $M$, induced by an action of $S^{1}$ on the cotangent fibres of $T^{\ast}\CC^{n}$ by rotation, \ie
	\[
		t\cdot (z,w) = (z,tw).
	\]
