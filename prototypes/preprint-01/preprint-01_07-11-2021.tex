...
\begin{document}
	...
	There is a residual Hamiltonian $S^{1}$-action on each hypertoric manifold $M$, descending from an action of $S^{1}$ on the cotangent bundle $T^{\ast}\CC^{n}$ by rotation, \ie
	\[
		t\cdot (z,w) = (z,tw).
	\]
