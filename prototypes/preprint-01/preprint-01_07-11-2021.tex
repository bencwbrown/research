...
\begin{document}
	...
	\]
	Each $\mcE_{A} \subseteq M$ is a K\"ahler submanifold of $M$ with respect to $\w_{\RR}$, and is the K\"ahler symplectic toric orbifold associated to $\Delta_{A}$, possible non-compact. 
