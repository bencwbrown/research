...
\begin{document}
	...
	\[
		\begin{tikzcd}[ampersand replacement=\&]
			0 \ar[r, "{\begin{pmatrix} e & f \\ g & h \end{pmatrix}}"] \& \arrow{r}{\pi}[swap]{\begin{bmatrix}	u_{1} & \ldots & u_{n} \end{bmatrix}}
			\& \mfk \ar[r, hook, "\imath"] \& \mft^{n} \ar[r, twoheadrightarrow, "\pi"] \& \mft^{d} \ar[r] \& 0,
		\end{tikzcd}
	\]
