...
\begin{document}
	...
	\[
			\mcE_{A} = \bar{\mu}_{\RR}^{-1}(\alpha) \cap \bar{\mu}_{\CC}^{-1}(0).
	\]
	Each $\mcE_{A} \subseteq M$ is a K\"ahler suborbifold of $M$ with respect to $\w_{\RR}$, and is the K\"ahler symplectic toric orbifold associated to $\Delta_{A}$ in its own right, possible non-compact. 
