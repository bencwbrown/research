...
\begin{document}
	...
	\begin{proof}
		...
		\]
 		...
 		To prove that $\bar{\jmath}$ is a symplectomorphism, observe that the map $m \mapsto (e, \mu(m))$ sends $M$ into the fibre $T_{e}^{\ast}K_{\CC} \cong \mfk_{\CC}^{\ast}$ which is Lagrangian, 
