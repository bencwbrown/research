...
\begin{document}
	...
	\]
	so that each quintuple $(M, g, J_{i}, \w_{i})$ constitutes a K\"ahler manifold in their own individual right for $i = 1, 2, 3$. Combining these three K\"ahler structures gives rise to a \emph{hyperk{\"a}hler structure} for $M$, which are necessarily $4n$-dimensional, $n \geq 1$.
