...
\begin{document}
	...
	Furthermore, If $M$ is acted upon by a compact Lie group $G$ in a Hamiltonian way, with moment map $\mu : M \ra \mfg^{\ast}$, then it is possible to lift the action of $G$ on $M$ to an action of $G$ on $\mcL$.
