...
\begin{document}
	...
	\]
	so that each quintuple $(M, g, J_{i}, \w_{i})$ constitutes a K\"ahler manifold in their own individual right for $i = 1, 2, 3$. Combining the three K\"ahler structures on $M$ of both the metric and the triple of K{\"a}hler forms gives rise to a \emph{hyperk{\"a}hler structure} on the manifold $M$, which are necessarily $4n$-dimensional, $n \geq 1$.
