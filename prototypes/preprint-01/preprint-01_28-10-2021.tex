...
\begin{document}
	...
	\]
	Suppose that $\lambda \in \mfg^{\ast} \oplus \mfg_{\CC}^{\ast}$ is a regular value of $\mu_{\HK}$ and central under the $G$-coadjoint action on , so that $\mu_{\HK}^{-1}(\lambda)$ is a $G$-invariant submanifold of $M$.
