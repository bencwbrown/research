...
\begin{document}
	...
	\]
	so that each quintuple $(M, g, J_{i}, \w_{i})$ constitutes a K\"ahler manifold in their own individual right for $i = 1, 2, 3$; combining these three K\"ahler structures together gives rise to a \emph{hyperk\"ahler structure} for $M$.
