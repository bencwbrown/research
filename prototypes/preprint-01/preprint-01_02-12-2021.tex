...
\begin{document}
   ...
   \end{equation}
	...
	\begin{example}
		...
		Now if we take $\lambda = (0, 0, a, b)$, we can take the symplectic quotient $X = \mu^{-1}(0)/K$, which is
		\[
			a
		\]
	...
	\begin{center}
		\begin{tikzpicture}[scale=1.00] %[x={10.0pt},y={10.0pt}]
			\draw[step=1.5cm,gray,very thin] (-1,-1) grid (4,4);
			\filldraw[fill=gray!10!white, draw=black] (0,0) -- (3,0) -- (0,3) -- cycle;
		\end{tikzpicture}% pic 1
		\qquad % <----------------- SPACE BETWEEN PICTURES
		\begin{tikzpicture}[scale=1.00] %[x={10.0pt},y={10.0pt}]
			\draw[step=1.5cm,gray,very thin] (-1,-1) grid (7,4);
