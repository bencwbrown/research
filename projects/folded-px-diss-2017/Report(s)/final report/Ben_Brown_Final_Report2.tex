...
\begin{subequations}
	...
	\end{gather}
\end{subequations}
\Cref{hk_conditiona} asserts the existence and non-degeneracy of the three \HK forms, whereas \cref{hk_conditionb} is the integrability condition stating that each $\w\indices{^i}$ is closed.\\
...
\begin{ex}[Gibbons-Hawking Ansatz]
	...
	%Integrability, Self-Duality and Twistor Theory Chapter 5
