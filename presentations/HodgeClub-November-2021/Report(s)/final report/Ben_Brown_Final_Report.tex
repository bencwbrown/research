...
\begin{subequations}
	...
	\end{gather}
\end{subequations}
\Cref{hk_conditiona} asserts the existence of the three \K\ forms and \cref{hk_conditionb} is the integrability condition that each $\w\indices{^a}$ is indeed \K.\\
