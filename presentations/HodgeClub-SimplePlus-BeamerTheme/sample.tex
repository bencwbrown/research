...
\begin{frame}{Examples - toric symplectic orbifolds}
	...
	\]
    \textcolor{blue}{\underline{Def:}} Polytope $\Delta$ is called \textcolor{red}{\underline{simple}} if for each vertex $v = \cap_{i=1}^{n}H_{i}$, the $u_{i}$ are linearly independent,
